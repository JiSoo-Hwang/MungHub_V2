...
<body>
	...
	<div id="Enroll-Rule-Area">
		...
		<div id="Rule1">
			...
			<input type="radio" name="yakgwan1" id="Y"><label for="Y">동의합니다.</label>
			<input type="radio" name="yakgwan1" id="N"><label for="N">동의하지 않습니다.</label>
		</div>
		<div id="Rule2">
			<textArea readOnly cols="30" rows="6" >
			...
			<input type="radio" name="yakgwan2" id="Y"><label for="Y">동의합니다.</label>
			<input type="radio" name="yakgwan2" id="N"><label for="N">동의하지 않습니다.</label>
		</div>
	...
	<script>
		$(function(){
			$("#agreeAll").attr("checked")(function(){
